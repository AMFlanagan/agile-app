...
function (_Component) {
  ...
  function OuterForm() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(OuterForm).call(this)); // this.state = {
    //     inputs: [<Input key={0} averageWeeklyVelocity={this.averageWeeklyVelocity || null}/>],
    //     averageWeeklyVelocity: null
    // };

    _this.state = {
      getTickets: _reducers_reducers__WEBPACK_IMPORTED_MODULE_1__["getTickets"]
    };
    return _this;
  }
  ...
  _createClass(OuterForm, [{
    ...
    value: function addInput() {
      ...
      this.setState(function (state) {
        return state.inputs.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Input__WEBPACK_IMPORTED_MODULE_2__["default"], {
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    tickets: getTicketss(state.tickets)
  };
};

/* harmony default export */ __webpack_exports__["default"] = (connect(mapStateToProps)(OuterForm));

/***/ })

})
//# sourceMappingURL=index.js.7748238d0d54c9ec15f7.hot-update.js.map