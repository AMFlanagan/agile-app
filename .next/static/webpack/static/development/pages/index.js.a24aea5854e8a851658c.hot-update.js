...
function tickets() {
  ...
  switch (action.type) {
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_2__["DEL_TICKET"]:
      state: _toConsumableArray(state.items.slice(0, action.payload)).concat(_toConsumableArray(state.items.slice(action.payload + 1))), console.log(state);
...
//# sourceMappingURL=index.js.a24aea5854e8a851658c.hot-update.js.map