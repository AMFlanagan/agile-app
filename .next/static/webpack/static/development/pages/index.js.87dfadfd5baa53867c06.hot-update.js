...
function tickets() {
  ...
  switch (action.type) {
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_2__["DEL_TICKET"]:
      return _toConsumableArray(state.items.slice(0, action.payload)).concat(_toConsumableArray(state.items.slice(action.payload + 1))), console.log(state);
...
//# sourceMappingURL=index.js.87dfadfd5baa53867c06.hot-update.js.map