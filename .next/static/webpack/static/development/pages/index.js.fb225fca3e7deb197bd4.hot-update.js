...
function tickets() {
  ...
  switch (action.type) {
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_2__["DEL_TICKET"]:
      return _toConsumableArray(state.slice(0, action.payload)).concat(_toConsumableArray(state.slice(action.payload + 1))), console.log(state);
...
//# sourceMappingURL=index.js.fb225fca3e7deb197bd4.hot-update.js.map