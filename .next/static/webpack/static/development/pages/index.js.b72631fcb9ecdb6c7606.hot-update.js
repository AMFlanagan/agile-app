...
function tickets() {
  ...
  switch (action.type) {
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_2__["DEL_TICKET"]:
      ...
      // ],
      console.log(_toConsumableArray(state.slice(0, action.payload)).concat(_toConsumableArray(state.slice(action.payload + 1))));
...
//# sourceMappingURL=index.js.b72631fcb9ecdb6c7606.hot-update.js.map