...
function tickets() {
  ...
  switch (action.type) {
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_2__["DEL_TICKET"]:
      ...
      // ],
      console.log(_toConsumableArray(state.slice(0, action.index)).concat(_toConsumableArray(state.slice(action.index + 1))));
...
//# sourceMappingURL=index.js.2cd78f80bece4efce0e2.hot-update.js.map