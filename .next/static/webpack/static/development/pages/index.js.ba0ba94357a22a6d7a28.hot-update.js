...
function tickets() {
  ...
  switch (action.type) {
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_2__["DEL_TICKET"]:
      tickets: _toConsumableArray(state.items.slice(0, action.payload)).concat(_toConsumableArray(state.items.slice(action.payload + 1))), console.log(state);
...
//# sourceMappingURL=index.js.ba0ba94357a22a6d7a28.hot-update.js.map